...
<div className="absolute top-0 left-0 w-64 h-64 
                  ...
                  rounded-full 
                  pointer-events-none" />
<div className="absolute top-[50%] left-[50%] w-124 h-124 
                  bg-[#32A0F4]/20 
                  blur-[220px] 
...
<div className="absolute top-[10%] right-[10%] w-64 h-64 
        ...
        <div className="space-y-8">
          <h2 className="text-3xl md:text-4xl font-light tracking-tight text-white/50"  style={{
              background: "linear-gradient(0deg, #F2F2F2 21.43%, #8C8C8C 80.36%)",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent",
            }}>Related Articles</h2>
              ...
              >
                <div>
                  <div className="flex justify-between items-start mb-4">
                    <span className="text-4xl font-bold text-blue-500 tracking-tighter opacity-80">{article.id}</span>
