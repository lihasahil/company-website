...
const CareersSection = () => {
  ...
  const jobs = [
    {
      ...
      salary: "10000$",
      description: "Lead the design of intuitive, mobile-first interfaces across our core platform, collaborate with...",
      type: "Full Time",
      location: "Kathmandu",
    },
    {
      ...
      salary: "10000$",
      description: "Ensure visual integrity of product design, ensuring alignment with brand guidelines.",
      type: "Contract",
    ...
    },
    {
      ...
      salary: "4400$",
      description: "Design interactive elements that create a seamless user experience.",
      type: "Full Time",
      location: "Toronto",
    },
    {
      ...
      salary: "6700$",
      description: "Manage a team of designers and optimize the design strategy for the product suite.",
      type: "Full Time",
      location: "London",
    },
    {
      ...
      salary: "5000$",
      description: "Develop and implement content strategies that enhance user engagement and experience.",
      type: "Contract",
      location: "Sydney",
    },
    {
    ...
    },
    {
      ...
      salary: "4500$",
      description: "Assist in developing design concepts and prototypes for various projects.",
      type: "Full Time",
      location: "Moscow",
    },
    {
  ...
  return (
    <section className="bg-[#020202] text-white py-24 px-6 md:px-12 font-sans overflow-hidden">
      <div className="max-w-[90%] mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start mb-6 gap-8">
          ...
          >
            Work with talented people who push each other to grow and create solutions the shapes the future of Tech and Artificial intelligence.
          </motion.p>
        </div>
        ...
        <div className="mb-20">
          <div className="mb-8">
            ...
            <p className="text-gray-500 text-lg max-w-xl">Discover a workplace where your talents are recognized, your voice matters, and your contribution helps shape the future.</p>
          </div>
            ...
            {benefits.map((benefit, i) => (
              ...
              >
                <div className="flex justify-between items-start mb-6">
                  <span className="text-4xl font-bold text-[#32A0F4] tracking-tighter">{benefit.id}</span>
                  <div className="w-10 h-10 rounded-full bg-[#111] border border-blue-500/20 flex items-center justify-center text-blue-500 shadow-[0_0_20px_rgba(0,112,243,0.1)]">
                    <ArrowRight size={18} className="transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5 -rotate-45" />
                  </div>
                </div>
        ...
        <div className="mb-20">
          <div className="mb-10">
            ...
            <p className="text-gray-500 text-lg max-w-xl">Browse our current job openings and see how you can contribute to our expanding team.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {jobs.map((job, i) => (
              ...
              >
                ...
                <h4 className="text-xl font-bold mb-3 tracking-tight">{job.title}</h4>
