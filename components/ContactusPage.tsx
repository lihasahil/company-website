...
export default function ContactUsPage() {
  return (
    <>
      ...
      <section className="hero-bg h-screen relative w-full flex flex-col items-center justify-center overflow-hidden">
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 gap-5">
          <motion.h1
