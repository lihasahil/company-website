...
const Node: React.FC<NodeProps> = ({ icon }) => {
  return (
    <div
      className="relative flex h-16 w-16 cursor-pointer items-center justify-center rounded-2xl text-gray-400 shadow-xl transition-all duration-300 group"
      style={{
        background:
          "linear-gradient(#0f172a, #0f172a) padding-box, linear-gradient(136.41deg, #056DBC 2.35%, #023256 100%) border-box",
